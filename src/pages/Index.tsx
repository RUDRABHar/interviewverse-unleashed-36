...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center py-20">
      {/* Dynamic Background */}
      <div className="absolute inset-0 -z-10">
        ...
        <ParticleBackground count={30} color="rgba(255, 107, 0, 0.4)" minSize={2} maxSize={6} />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          opacity: 0,
          y: 50
        }} animate={controls} className="flex flex-col space-y-6">
            <motion.span className="text-sm md:text-base text-orange-600 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/30 w-fit px-4 py-1.5 rounded-full font-medium" initial={{
            opacity: 0,
            y: -20
          }} animate={{
            opacity: 1,
            ...
            <motion.div className="content-wrapper" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            duration: 0.8
              ...
              <div className="flex flex-wrap gap-4 pt-6">
                <AnimatedButton size="lg" glowEffect gradientBg iconRight={<ArrowRight className="ml-1 h-5 w-5 transition-transform group-hover:translate-x-1" />} className="rounded-full px-8 py-6 text-lg font-medium group" asChild>
                  <Link to="/auth">Start Now</Link>
                </AnimatedButton>
                
                <AnimatedButton size="lg" variant="outline" className="rounded-full px-8 py-6 text-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-colors bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm" asChild>
                  <Link to="#how-it-works">See How It Works</Link>
                </AnimatedButton>
              </div>
            </motion.div>
            
            <motion.div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 pt-4 bg-white/60 dark:bg-gray-800/60 p-3 rounded-lg backdrop-blur-sm" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            duration: 0.8
              ...
              <div className="flex -space-x-2">
                {[...Array(4)].map((_, i) => <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 border-2 border-white dark:border-gray-800 flex items-center justify-center overflow-hidden shadow-md text-white">
          ...
          delay: 0.3
            ...
            <div className="relative w-full max-w-lg">
              ...
              <motion.div className="relative p-8" animate={{
              y: [0, -10, 0]
            }} transition={{
              duration: 6,
              repeat: Infinity,
...
const Features = () => {
  ...
  return <section id="features" className="py-20 md:py-32 relative">
...
const FeatureCard = ({
  ...
  return <motion.div ref={ref} initial={{
    ...
    delay: index * 0.1
      ...
      <PremiumCard variant="glassmorphic" hoverEffect className="h-full p-6">
...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="py-20 md:py-32 bg-gray-50 dark:bg-gray-900/50 relative">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
...
const TestimonialCard = ({
  ...
  return <motion.div ref={ref} initial={{
    ...
    delay: index * 0.1
      ...
      <PremiumCard variant="glassmorphic" className="h-full p-6">
...
// CTA Section
const CTASection = () => {
  const benefits = ["Personalized AI feedback on every answer", "Access to premium interview questions", "Detailed performance analytics", "Industry-specific practice interviews"];
  const ref = React.useRef(null);
  const isInView = useInView(ref, {
    once: true
  });
  return <section className="py-20 md:py-32 bg-gray-50 dark:bg-gray-900/50 relative">
      <div ref={ref} className="container mx-auto px-4">
        ...
        duration: 0.5
          ...
          <PremiumCard variant="elevated" glowEffect className="overflow-visible">
